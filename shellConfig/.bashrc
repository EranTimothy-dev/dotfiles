...
__conda_setup="$('/home/mugiwara_timoshii/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/mugiwara_timoshii/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/mugiwara_timoshii/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/mugiwara_timoshii/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export OSH='/home/mugiwara_timoshii/.oh-my-bash'
...
# aliases
#alias ollama='$Asus/AppData/Local/Programs/Ollama/ollama.exe'
alias olsbg='OLLAMA_MODELS=/mnt/d/Ollama/Models ollama serve >| ollama.log 2>&1 &'
alias code="$Asus/AppData/Local/Programs/'Microsoft VS Code'/Code.exe"
